...
def IniciarExtraccion(cloud_event: CloudEvent) -> None:
    try:
        ...
        _M_BUCKET_DATA = str(os.environ.get('_M_BUCKET_DATA'))
        extraccion = avalon.Extraccion(_m_account=_m_account)
        ...
        msg=f'La funcion de ejecución IniciarExtraccion de Avalon ha terminado en error:{type(e)}: {e}.'
        print(msg)
