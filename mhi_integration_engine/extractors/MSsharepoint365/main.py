...
from worker.sharepoint365 import Extraer
...
__EXTRACTOR_NAME = 'sharepoint365'
...
def IniciarExtraccion(cloud_event):
    ...
    try:
        ...
        msg=f'La funcion de ejecución IniciarExtraccion de Sharepoint365 ha terminado en error:{type(e)}: {e}.'
        logger.error(msg)
...
if __name__ == "__main__":
    ...
    print("Iniciando prueba local del extractor Axional...")
